...
class _FlaskSstiPageState extends BaseVulhubExpPageState<FlaskSstiExpPage> {
  ...
  @override
  String get appBarTitle => S.vulhubFlaskSstiTitle;
  @override
  String get cardTitle => S.vulhubFlaskSstiCardTitle;
  @override
  String get cardSubtitle => S.vulhubFlaskSstiCardSubtitle;
  ...
  Future<void> _check() async {
    ...
    try {
      ...
      appendLog(
        r.vulnerable ? '[+] ${r.vulnName}: ${r.detail}' : '[-] 未检测到 SSTI',
      );
    } catch (e) {
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          vSecTitle(S.sectionRequestHeaders),
          _multiTf(
            _headersCtrl,
            '自定义 Headers',
          ...
          const SizedBox(height: 12),
          vSecTitle(S.sectionRequestBody),
          _multiTf(
            _bodyCtrl,
